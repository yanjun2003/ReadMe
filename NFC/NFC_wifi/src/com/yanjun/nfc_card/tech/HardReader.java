...
package com.yanjun.nfc_card.tech;

import java.util.ArrayList;

import android.content.res.Resources;

import com.yanjun.nfc_card.tech.Iso7816.BerT;
...
final class HardReader extends PbocCard {
	...
	private HardReader(Iso7816.Tag tag, byte[] name, Resources res) {
		super(tag);
		this.name = (name != null) ? com.yanjun.nfc_card.Util.toHexString(name, 0, name.length)
